...
with DAG(dag_id='BigData_YaApi_visits_date_selection_v3',
    ...
    tlgrm_allSuccess = PythonOperator(
        ...
        op_kwargs={
            'message': f"Отработал успешно ✅ - DAG visits_date_selection_{start_date_v}_{end_date_v}"}
    )
    ...
    tlgrm_oneFailed = PythonOperator(
        ...
        op_kwargs={
            'message': f"Упал 🛑 - DAG visits_date_selection_{read_request_id()}_{start_date_v}_{end_date_v}"}
    )
