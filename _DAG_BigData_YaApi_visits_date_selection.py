...
start_date_v = selectDateJsonData['YaApiVisitsDate']['startDate']
end_date_v = selectDateJsonData['YaApiVisitsDate']['endDate']
...
with DAG(dag_id='BigData_YaApi_visits_date_selection',
    ...
    tlgrm_allSuccess = PythonOperator(
        ...
        op_kwargs={
            'message': f"Отработал успешно ✅ - DAG visits_selectDate_{start_date_v}_{end_date_v}"}
    )
    ...
    tlgrm_oneFailed = PythonOperator(
        ...
        op_kwargs={
            'message': f"Упал 🛑 - DAG visits_selectDate_{request_id_v}_{start_date_v}_{end_date_v}"}
    )
    ...
    logging_faild = PythonOperator(
        ...
        trigger_rule='one_failed',
        op_kwargs={
            'text': f"DAG visits_selectDate_{request_id_v}_{start_date_v}_{end_date_v} - faild" + "\n",
