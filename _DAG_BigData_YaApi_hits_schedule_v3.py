...
start_date_v = str(datetime.date(datetime.today()) - timedelta(days=421))
end_date_v = str(datetime.date(datetime.today()) - timedelta(days=421))
...
with DAG(dag_id='BigData_YaApi_hits_schedule_v3',
