...
start_date_v = str(datetime.date(datetime.today()) - timedelta(days=420))
end_date_v = str(datetime.date(datetime.today()) - timedelta(days=420))
...
with DAG(dag_id='BigData_YaApi_visits_schedule_v3',
